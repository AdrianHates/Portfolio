  ...
  <section id={id} ref={el => (elementsRef.current[3] = el)}>
      ...
      <form action="https://formspree.io/f/xzbnzbyn" method="POST" aria-labelledby='datos-contacto'>
        ...
        <div>
          ...
          <textarea name='mensaje' placeholder={idioma==='ES'?'Mensaje':'Message'} type='text' rows='5' cols='24' required></textarea>
        </div>
        <button className='btn-show-all' type="submit">{idioma==='ES'?'Enviar':'Send'}</button>
      </form>
      <div>
      ...
      <Red src={freeCodeCamp} href='https://www.freecodecamp.org/herlessoliver'></Red>
